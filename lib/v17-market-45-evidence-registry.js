...
const PENDING_EVIDENCE = [
  {
    ...
    status: "BATCH_VERIFIED_QCOM_PAPER_TEST_APPROVED",
    tag: "批次驗證通過 / 7天紙上",
    decision: "QCOM 通過批次驗證：手機週期仍是風險，但 Auto / IoT / Edge AI 延伸足以進 7 天小額紙上交易；不得進真實交易。",
    blocker: null,
    riskFlag: "手機週期、授權收入與 Android OEM 需求仍需追蹤；紙上測試限 5U。",
    permissions: { paperTrading: true, formalObservation: false, realAutoTrade: false },
    nextVerification: ["7 天紙上 PnL", "QCT handset trend", "Auto / IoT growth", "QTL licensing stability"],
  },
  {
    symbol: "ORCL",
  ...
  },
  {
    ...
    status: "BATCH_VERIFIED_REGN_FORMAL_ONLY_EYLEA_RISK",
    tag: "批次驗證 / 正式觀察，不紙上",
    decision: "REGN 品質可保留正式觀察，但 EYLEA / pipeline / patent 風險不適合進紙上交易。",
    blocker: null,
    riskFlag: "Dupixent 強，但 EYLEA / pipeline / 專利與集中度需追蹤。",
    permissions: { paperTrading: false, formalObservation: true, realAutoTrade: false },
    nextVerification: ["EYLEA / EYLEA HD trend", "Dupixent contribution", "pipeline catalysts", "patent / concentration risk"],
  },
  {
    symbol: "UNH",
    evidenceStatus: "FORMAL_ONLY_VERIFIED",
    sourceStatus: "BATCH_VERIFIED_FORMAL_ONLY",
    status: "BATCH_VERIFIED_UNH_FORMAL_ONLY_MLR_REGULATORY",
    tag: "批次驗證 / 正式觀察，不紙上",
    decision: "UNH 可列正式觀察，因 MLR 與 guidance 有改善跡象；但監管 / DOJ / Medicare 風險仍不適合進紙上交易。",
    blocker: null,
    riskFlag: "MLR、Medicare / DOJ / regulatory risk、Optum trend 需持續追蹤。",
    permissions: { paperTrading: false, formalObservation: true, realAutoTrade: false },
    nextVerification: ["medical loss ratio", "guidance change", "regulatory / DOJ / Medicare risk", "Optum growth"],
  },
  {
    symbol: "DELL",
    evidenceStatus: "FORMAL_ONLY_VERIFIED",
...
export function getMarket45EvidenceRegistry() {
  ...
  return {
    version: "v17-market-45-evidence-registry-v3-final-decisions",
