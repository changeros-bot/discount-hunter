...
const riskMap = {
  ...
  NFLX: ["subscriber growth", "ad-tier monetization", "content spend", "margin durability", "competition", "valuation"],
  BKNG: ["room nights", "gross travel bookings", "take rate", "marketing efficiency", "regulation", "valuation"],
...
function getQualityGateDrafts() {
  return {
    version: "v17-market-91-quality-gate-drafts-v8-consumer-platforms-expanded",
