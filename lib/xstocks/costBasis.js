// DCA Discount Hunter V15.8 - Cost Basis Engine
...
// Amount parsing is decimal-aware to avoid treating formatted Moralis values as raw wei.
...
function looksRawInteger(value, decimals) {
  ...
  // Small values such as "2000" from Moralis are often already formatted amounts.
...
function txAmount(tx) {
  ...
  // Fallback for Moralis / indexers that already return formatted decimal amounts in value.
