...
const QUALITY_GATE_RULES = {
  version: "v17-market-91-quality-gate-queue-v10-fourteenth-batch-eda-enabled",
...
function buildQueueCandidate(row) {
  ...
  const priorityMap = {
    ...
    BKNG: { priority: 15, mainRisk: "Travel demand cycle, room nights growth, take rate, marketing efficiency, regulation, and valuation must be verified.", preliminaryGateBias: "HIGH_CASHFLOW_TRAVEL_PLATFORM_BUT_CYCLE_REGULATION_AND_VALUATION_MUST_BE_VERIFIED" },
    ISRG: { priority: 16, mainRisk: "Procedure growth, system placements, recurring instrument revenue, margin durability, competition, hospital CapEx cycle, and valuation must be verified.", preliminaryGateBias: "HIGH_QUALITY_ROBOTIC_SURGERY_PLATFORM_BUT_PROCEDURE_GROWTH_AND_VALUATION_MUST_BE_VERIFIED" },
    ROP: { priority: 17, mainRisk: "Organic growth, acquisition discipline, FCF quality, leverage, software mix, and valuation must be verified.", preliminaryGateBias: "QUALITY_VERTICAL_SOFTWARE_COMPOUNDER_BUT_MA_AND_VALUATION_MUST_BE_VERIFIED" },
    MU: { priority: 18, mainRisk: "HBM ramp, pricing, margin durability, CapEx, supply growth, and customer qualification must be verified.", preliminaryGateBias: "PROMISING_AI_MEMORY_CORE_BUT_HBM_MARGIN_AND_CAPEX_MUST_BE_VERIFIED" },
    VRT: { priority: 19, mainRisk: "Backlog quality, margin durability, delivery execution, working capital, and valuation sensitivity must be verified.", preliminaryGateBias: "PROMISING_BUT_EXECUTION_AND_BACKLOG_QUALITY_MUST_BE_VERIFIED" },
    INTU: { priority: 20, mainRisk: "AI disruption in tax/accounting, TurboTax and QuickBooks growth durability, SMB cycle, margin durability, and valuation must be verified.", preliminaryGateBias: "QUALITY_VERTICAL_SOFTWARE_BUT_AI_TAX_DISRUPTION_AND_VALUATION_MUST_BE_VERIFIED" },
  };
