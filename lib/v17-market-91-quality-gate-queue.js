...
const QUALITY_GATE_RULES = {
  version: "v17-market-91-quality-gate-queue-v3-fourth-batch-anet-enabled",
...
function buildQueueCandidate(row) {
  ...
  return {
    ...candidate,
    priority: 99,
    mainRisk: row.blocker || "No specific risk recorded.",
    preliminaryGateBias: "UNRANKED",
  };
}
