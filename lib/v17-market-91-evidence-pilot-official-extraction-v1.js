const EVIDENCE_PILOT_OFFICIAL_EXTRACTION_ROWS = [
  ...
  {
    symbol: "AVGO",
    evidenceStatus: "OFFICIAL_SOURCE_PENDING_NOT_LOCKED",
  ...
  {
    symbol: "ORCL",
    evidenceStatus: "OFFICIAL_SOURCE_PENDING_NEGATIVE_CONTROL_NOT_LOCKED",
    sourceTier: "official_required_not_yet_extracted",
    sourceUrl: null,
    extractedFacts: {},
...
function getEvidencePilotOfficialExtractionV1() {
  return {
    version: "v17-market-91-evidence-pilot-official-extraction-v1-nvda-only-partial",
    ...
    summary: {
      ...
      officialPending: EVIDENCE_PILOT_OFFICIAL_EXTRACTION_ROWS.filter((x) => x.evidenceStatus.includes("OFFICIAL_SOURCE_PENDING")).length,
