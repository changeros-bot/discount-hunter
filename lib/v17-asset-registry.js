...
export const ASSET_REGISTRY = [
  {
    ...
    automation: { draftEligible: true, canaryEligible: true, route: "binance_spot", requiresManualConfirmation: true },
  ...
  },
  {
    ...
    status: ASSET_STATUS.QUALIFIED,
    automation: { draftEligible: false, canaryEligible: false, route: "manual_only", reason: "ETF mirror is not part of automation." },
  ...
  },
  {
    ...
    status: ASSET_STATUS.QUALIFIED,
    automation: { draftEligible: true, canaryEligible: false, route: "manual_web3_only", requiresManualConfirmation: true },
    discountModel: "xstock_52w_v1",
  ...
  },
  {
    ...
    status: ASSET_STATUS.QUALIFIED,
    automation: { draftEligible: false, canaryEligible: false, route: "blocked", reason: "Reliable since-listing history is still pending." },
  ...
  },
  {
    ...
    automation: { draftEligible: false, canaryEligible: false, route: "blocked", reason: "Watch status is never auto eligible." },
    discountModel: "xstock_52w_v1",
