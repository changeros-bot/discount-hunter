...
function getBinanceRestUrl() {
  // V17 sealed rule: Binance read-only calls must go through the Oracle proxy
  // recorded in the handoff. Do not read BINANCE_REST_BASE_URL here; serverless
  // or custom-host proxies can trigger Binance restricted-location errors.
