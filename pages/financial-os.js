...
const categoryMeta = {
  飲食: { icon: '餐', hint: '餐飲與日常食品' },
  家用: { icon: '家', hint: '家用與居家修繕' },
  教育: { icon: '學', hint: '學費與學習' },
  服飾: { icon: '衣', hint: '服裝與雨具' },
  交通: { icon: '行', hint: '交通與機車' },
  娛樂: { icon: '樂', hint: '休閒娛樂' },
  醫療: { icon: '醫', hint: '醫療健康' },
  金融: { icon: '金', hint: '金融費用' },
  固定支出: { icon: '固', hint: '每月固定支出' },
  生活用品: { icon: '物', hint: '生活用品' },
  其他: { icon: '其', hint: '其他支出' },
